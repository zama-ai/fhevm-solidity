...
| **Repository**                                            | **Description**                                                 |
| --------------------------------------------------------- | --------------------------------------------------------------- |
| [fhevm](https://github.com/zama-ai/fhevm-solidity/)                | Solidity library for FHE operations                             |
| [fhevmjs](https://github.com/zama-ai/fhevm-js/)            | JavaScript library for client-side FHE                          |
