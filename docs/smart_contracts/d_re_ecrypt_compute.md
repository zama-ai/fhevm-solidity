...
Re-encryption is initiated on the client side via the **Gateway service** using the [`@httpz/sdk`](https://github.com/zama-ai/fhevm-js/) library. Here’s the general workflow:
